...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "APEX Global Education — Study Abroad Consultancy" },
      {
        name: "description",
        content:
          "Personalised study-abroad guidance: course selection, university shortlisting, applications, visas and pre-departure support.",
      },
      { name: "author", content: "APEX Global Education" },
      { property: "og:site_name", content: "APEX Global Education" },
